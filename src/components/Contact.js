...
const Contact = () => {
  ...
  return (
    <>
      <h1 id="contact" className="text-3xl text-center mt-7">
        Contact Us
      </h1>

      <section className="section-sm my-4 lg:pt-[250px]">
          ...
          >
            ...
            >
              <h2 className="h2 mb-3 lg:mb-7 text-green">
                Tanwishlife that never get old !
              </h2>
              <p className="mb-7 lg:mb-0">
                Each Veda is further divided into four sections: Samhitas,
                Brahmanas, Aranyakas, and Upanishads, each serving a specific
                purpose in the practice of Hinduism.
              </p>
            </div>
            <form
            ...
            >
              ...
              />
              <textarea
                className="form-control py-5 h-[165px] resize-none  border border-black p-2"
                placeholder="Message"
                name="user_message"
              ></textarea>
              <button
